...
void loop() {
  ...
  delay(motorTime1b+1); // Change if motor over/undershoots A6
...
// Measure 5
  ...
  digitalWrite(motor2s, motorSpd2+6); // Moves belt 2 to D6-F6
  digitalWrite(motor2d, 1);

  delay(motorTimeJump2R-4);
  digitalWrite(motor2s, 0);
...
//measure 24
  ...
  delay(timing[3]);
  digitalWrite(solenoid4, LOW);
  digitalWrite(solenoid1, HIGH); //Cs7
  delay(timing[3]);
  digitalWrite(solenoid1, LOW);
